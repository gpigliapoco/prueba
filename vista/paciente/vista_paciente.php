        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <input type="text" id="txtIdpaciente">
                            <label for="">Nombre</label>
                            <input type="text" class="form-control" id="txt_nombreEditar"
                                placeholder="Ingrese nombre"><br>
                        </div>
                        <div class="col-lg-6">
                            <label for="">Apellido</label>
                            <input type="text" class="form-control" id="txt_apellidoEditar"
                                placeholder="Ingrese Apellido"><br>
                        </div>
                        <div class="col-lg-6">
                            <label for="">direccion</label>
                            <input type="text" class="form-control" id="txt_direccionEditar"
                                placeholder="Ingrese Direccion"><br>
                        </div>
                        <div class="col-lg-6">
                            <label for="">Documento</label>
                            <input type="text" class="form-control" id="txt_dniEditar"
                                placeholder="Ingrese Documento"><br>
                        </div>
                        <div class="col-lg-4">
                            <label for="">movil</label>
                            <input type="text" class="form-control" id="txt_movilEditar"
                                placeholder="Ingrese Movil"><br>
                        </div>
                        <div class="col-lg-4">
                            <label for="">Sexo</label>
                            <select class="js-example-basic-single" name="state" id="cbm_sexoEditar"
                                style="width:100%;">
                                <option value="m">MASCULINO</option>
                                <option value="f">FEMENINO</option>
                            </select><br><br>
