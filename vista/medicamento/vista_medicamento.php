...
<div class="col-md-12">
    <div class="box box-warning box-solid">
        <div class="box-header with-border">
              <h3 class="box-title">BIENVENIDO A MEDICAMENTOS</h3>
...
<form autocomplete="false" onsubmit="return false">
    <div class="modal fade" id="modal_registro_medicamento" role="dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="col-lg-12">
                    ...
                    <input type="text" class="form-control" id="txt_medicamento" placeholder="ingrese medicamento" maxlenght="5" onkeypress="return soloLetras(event)"  ><br>
                </div>               
            </div>
            <div class="modal-body">
                <div class="col-lg-12">
...
<form autocomplete="false" onsubmit="return false">
    <div class="modal fade" id="modal_editar_medicamento" role="dialog">
        <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            ...
            <div class="modal-body">
                <div class="col-lg-12">
                    <input type="text" id="txtIdimedicamento" hidden> 
                    <label for="">Medicamento</label>
            ...
            <div class="modal-footer">
                <button class="btn btn-primary" onclick="modificarmedicamentos()"><i class="fa fa-check"><b>&nbsp;Modificar</b></i></button>
                <button type="button" class="btn btn-danger" data-dismiss="modal"><i class="fa fa-close"><b>&nbsp;Cerrar</b></i></button>
            </div>
        </div>
        </div>
...
$(document).ready(function() {
    listar_medicamento();
    $("#modal_registro_medicamento").on('shown.bs.modal',function(){
